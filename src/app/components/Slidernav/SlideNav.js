...
const SlideNav = () => {
  ...
  return (
    <>
      ...
      {/* <div className="row">
        <div className="">
          <div className="testimonial-slider" style={{ margin: "0px 70px" }}>
            <Slider asNavFor={nav2} ref={(slider) => (sliderRef1 = slider)}>
                {sliderepest.map((index) => {
                  return (
                    <div key={index} className="testimonial-item">
                      ...
                      <div className="testimonial-content">
                        <p>
                          "Will gave our website and brand whole new life while
                          staying true to who we are. We would never have
                          thought of going in the direction he pitched but we
                          couldn't be happier."
                        </p>
                      </div>
                    </div>
            ...
            >
               {
                data.map((item,index) => {
                  return(
                    <div key={index} className="testimonial-user-item d-flex justify-content-center align-items-center">
                    <div className="testimonial-user-thumb">
                      <img src={item?.image} alt="avtar-image" />
                    </div>
                    <div className="testimonial-user-content">
